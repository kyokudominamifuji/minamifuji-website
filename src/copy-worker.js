    ...
    <div class="wrap repertoire-wrap">
      ...
      <div class="repertoire-block">
        ...
        <article class="repertoire-group">
          ...
          <div class="story"><h5>「秀吉の初陣」</h5><p data-ja="若き秀吉が戦場へ。後の天下人につながる度胸と才覚を描く一席。" data-en="Young Hideyoshi takes to the battlefield, revealing the courage and talent that foreshadow the future ruler of Japan.">若き秀吉が戦場へ。後の天下人につながる度胸と才覚を描く一席。</p></div>
          <div class="story"><h5>「秀吉と易者」</h5><p data-ja="まだ何者でもなかった秀吉と易者との出会い。運命と人を見る目を楽しむ物語。" data-en="An encounter between an unknown Hideyoshi and a fortune-teller — a tale about destiny and the ability to see the person within.">まだ何者でもなかった秀吉と易者との出会い。運命と人を見る目を楽しむ物語。</p></div>
          <div class="story"><h5>「三日普請」</h5><p data-ja="無理難題を前に、秀吉の知恵と人を動かす力が光る。" data-en="Faced with an impossible task, Hideyoshi's ingenuity and gift for moving people come to the fore.">無理難題を前に、秀吉の知恵と人を動かす力が光る。</p></div>
          <div class="story"><h5>「呑み取りの槍（黒田節の由来）」</h5><p data-ja="酒と名槍をめぐる豪快な勝負。『酒は飲め飲め』で知られる黒田節へとつながる人気の一席。" data-en="A bold contest over sake and a famous spear, leading into the story behind the celebrated song Kuroda-bushi.">酒と名槍をめぐる豪快な勝負。「酒は飲め飲め」で知られる黒田節へとつながる人気の一席。</p></div>
          <div class="story"><h5>「秀吉と利休」</h5><p data-ja="天下人・秀吉と茶人・千利休。二人の個性と美意識がぶつかり合う物語。" data-en="The ruler Hideyoshi and tea master Sen no Rikyū meet in a story where powerful personalities and aesthetics collide.">天下人・秀吉と茶人・千利休。二人の個性と美意識がぶつかり合う物語。</p></div>
      ...
      <div class="repertoire-block original-block">
        ...
        <article class="repertoire-group original-story"><h4>「ディアナ号の錨」</h4><p data-ja="静岡に残る歴史を題材に、地域の記憶を講談としてよみがえらせる一席。" data-en="A Kōdan performance that revives a piece of Shizuoka's local history and collective memory.">静岡に残る歴史を題材に、地域の記憶を講談としてよみがえらせる一席。</p></article>
        <article class="repertoire-group original-story"><h4>「長さん小路の由来」</h4><p data-ja="何気なく通り過ぎてしまう地名にも、物語がある。地域に眠る歴史を掘り起こす講談。" data-en="Even a place name we pass without notice can hold a story. This piece uncovers history sleeping within the local landscape.">何気なく通り過ぎてしまう地名にも、物語がある。地域に眠る歴史を掘り起こす講談。</p></article>
        <article class="repertoire-group original-story"><h4>「歌川広重伝・名勝 左富士」</h4><p data-ja="浮世絵師・歌川広重と、東海道・吉原の『左富士』。富士のまちから生まれた風景を物語に。" data-en="Ukiyo-e artist Utagawa Hiroshige and the famous Left Fuji view of Yoshiwara on the Tōkaidō — a local landscape reborn as story.">浮世絵師・歌川広重と、東海道・吉原の「左富士」。富士のまちから生まれた風景を物語に。</p></article>
        <article class="repertoire-group original-story"><h4>「賢者たちの贈り物」</h4><p data-ja="時代も国も越えて愛される物語を、講談のリズムと言葉で届ける一席。" data-en="A beloved story crossing eras and borders, retold through the rhythm and language of Kōdan.">時代も国も越えて愛される物語を、講談のリズムと言葉で届ける一席。</p></article>
        <article class="repertoire-group original-story"><h4>「鍵盤に命をかけた男たち」</h4><p data-ja="音楽と人間の情熱を、講談という語りの力で描く新しい挑戦。" data-en="A new Kōdan challenge portraying music and human passion through the power of storytelling.">音楽と人間の情熱を、講談という語りの力で描く新しい挑戦。</p></article>
      </div>
